...
export default function SettingsModal({ open, onClose, onSave, title = "Settings", children, }) {
    useEffect(() => {
        if (!open)
            return;
        const onKeyDown = (e) => {
    ...
    if (!open)
        return null;
    return (<div className="settingsOverlay" role="dialog" aria-modal="true">
      ...
      <div className="settingsCard" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="settingsFooter">
          ...
          <button className="settingsBtn primary" onClick={onSave} disabled={!onSave}>
            Save
          </button>
        </div>
      </div>
