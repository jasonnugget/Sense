...
export default function MainPage({
  ...
  const [createGroupTarget, setCreateGroupTarget] = useState<'tabs' | 'assign'>('tabs')
  ...
  const openCreateGroupModal = (target: 'tabs' | 'assign') => {
  ...
  const handleCreateGroup = (name: string) => {
    ...
    if (!createdId) return
    if (createGroupTarget === 'tabs') setSelectedGroupId(createdId)
